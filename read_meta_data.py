...
READ META DATA OF TREATY DECISIONS INTO DATAFRAME
...
meta_data = open("Downloads/Meta Data.txt", "r") #read txt file


#create dictionary, so that it can be converted later
meta_dict = {"Title":[], "Document type":[], "Reference Number":[], "Date":[], "Source":[], "Status":[], "Subject":[], "Meeting":[], "Treaty":[],"Website":[]}
...
meta_df.to_csv("Meta Data Treaty Decisions.csv")
print(meta_df)
